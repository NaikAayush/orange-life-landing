              ...
              <form>
                <div class="flex flex-wrap -mx-3 mb-4">
                  <div class="w-full px-3">
                    ...
                    <input id="email" type="email" class="form-input w-full text-gray-300" placeholder="you@yourcompany.com" autocomplete required />
                  </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-4">
                  <div class="w-full px-3">
                    <label class="block text-gray-300 text-sm font-medium mb-1" for="password">Password</label>
                    <input id="password" type="password" class="form-input w-full text-gray-300" placeholder="Password (at least 10 characters)" autocomplete required />
                  </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-4">
                  <div class="w-full px-3">
                    <div class="flex justify-between">
                      ...
                      <router-link to="/reset-password" class="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out">Forgot Password?</router-link>
                    </div>
                  </div>
                </div>
                <div class="flex flex-wrap -mx-3 mt-6">
                  <div class="w-full px-3">
                    <button class="btn text-white bg-purple-600 hover:bg-purple-700 w-full">Sign in</button>
                  </div>
                </div>
              </form>
              <div class="text-gray-400 text-center mt-6">
                Don’t you have an account? <router-link to="/signup" class="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out">Sign up</router-link>
              </div>
            </div>
