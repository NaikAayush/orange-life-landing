            ...
            <aside class="md:w-64 mb-16 md:mb-0 md:mr-10 md:flex-shrink-0" data-aos="fade-up" data-aos-delay="200">
              ...
              <nav>
                <ul>
                  ...
                  <li class="py-2 border-b border-gray-800">
                    <a :class="{ 'text-purple-600': page === '4' }" class="flex items-center px-3 group text-gray-400 hover:text-purple-600 transition duration-150 ease-in-out" href="https://life.theorange.network/" @click.prevent="page = '4'">
